package com.holo.wifichat.fragment;
...
public class AppSelectorFragment extends Fragment implements AdapterView.OnItemClickListener, AbsListView.MultiChoiceModeListener {
    ...
    List<BasicFileInformation> appDir = new ArrayList<>();
...
//        mAppGridView.setOnItemSelectedListener();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        try {
            ...
            this.appDir.add(new BasicFileInformation(appDir));
    ...
    private void startResult() {
        ...
        bundle.putSerializable("files", (Serializable) appDir);
